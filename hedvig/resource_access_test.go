...
`, os.Getenv("HV_TESTNODE"), os.Getenv("HV_TESTUSER"), os.Getenv("HV_TESTPASS"), os.Getenv("HV_TESTCLUST"), os.Getenv("HV_TESTCLUST"), os.Getenv("HV_TESTCLUST"), os.Getenv("HV_TESTCONT"), os.Getenv("HV_TESTCLUST"), os.Getenv("HV_TESTCONT"), os.Getenv("HV_TESTCLUST"), os.Getenv("HV_TESTADDR"), os.Getenv("HV_TESTCLUST"), os.Getenv("HV_TESTADDR"))
