...
resource "hedvig_vdisk" "test-vdisk2" {
  cluster = "%s"
  name = "HedvigVdiskTest2"
  size = 11
  type = "NFS"
}
`, os.Getenv("HV_TESTNODE"), os.Getenv("HV_TESTUSER"), os.Getenv("HV_TESTPASS"), os.Getenv("HV_TESTCLUST"), os.Getenv("HV_TESTCLUST"))
